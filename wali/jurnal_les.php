                ...
                <div class="card-header">
                    ...
                    <div class="card-header-action">
                        <div class="btn-group mr-2">
                            <a href="../config/export_jurnal_les_pdf.php?session_type=wali&kelas=<?php echo $selected_class; ?>&guru=<?php echo $teacher['id_guru']; ?>" target="_blank" class="btn btn-danger">
                                <i class="fas fa-file-pdf"></i> PDF
                            </a>
                            <a href="../config/export_jurnal_les_excel.php?session_type=wali&kelas=<?php echo $selected_class; ?>&guru=<?php echo $teacher['id_guru']; ?>" target="_blank" class="btn btn-success">
