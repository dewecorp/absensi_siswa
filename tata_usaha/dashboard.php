...
$guru_laki = isset($result['total_laki']) ? (int)$result['total_laki'] : 0;
$guru_perempuan = isset($result['total_perempuan']) ? (int)$result['total_perempuan'] : 0;
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="rounded-circle bg-white text-primary d-flex align-items-center justify-content-center mr-3 flex-shrink-0" style="width: 48px; height: 48px; font-weight: 600; font-size: 1.25rem; box-shadow: 0 4px 12px rgba(0, 0, 0, .25);">
                                            <?php echo strtoupper(substr($display_name ?? ($_SESSION['nama'] ?? $_SESSION['username'] ?? 'T'), 0, 1)); ?>
                                        </div>
                                        <div>
                                            <div class="mb-1 text-white" style="font-size: 0.95rem;">Assalamualaikum, <span class="font-weight-bold" style="font-size: 1.1rem;"><?php echo htmlspecialchars($display_name ?? ($_SESSION['nama'] ?? $_SESSION['username'] ?? 'Petugas TU')); ?></span></div>
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-muted small mt-1">
                                            <span title="Laki-laki"><i class="fas fa-mars text-info"></i> <strong><?php echo $siswa_laki; ?></strong></span> &nbsp; 
                                            <span title="Perempuan"><i class="fas fa-venus text-warning"></i> <strong><?php echo $siswa_perempuan; ?></strong></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-4 col-md-6 col-lg-4">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <strong><?php echo $total_guru; ?></strong>
                                        <div class="text-muted small mt-1">
                                            <span title="Laki-laki"><i class="fas fa-mars text-info"></i> <strong><?php echo $guru_laki; ?></strong></span> &nbsp; 
                                            <span title="Perempuan"><i class="fas fa-venus text-warning"></i> <strong><?php echo $guru_perempuan; ?></strong></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-4 col-md-6 col-lg-4">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <strong><?php echo $guru_hadir; ?></strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-4 col-md-6 col-lg-4">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <strong><?php echo $guru_sakit; ?></strong>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-4 col-md-6 col-lg-4">
                            <div class="card card-statistic-1">
                                ...
                                <div class="card-wrap">
                                    ...
                                    <div class="card-body">
                                        <strong><?php echo $guru_izin; ?></strong>
                                    </div>
                                </div>
                            </div>
                        </div>
