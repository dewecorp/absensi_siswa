...
INSERT INTO `tb_activity_log` VALUES (695,'admin','Login','User logged in successfully','::1','2026-02-07 07:30:03'),(696,'admin','Login','User logged in successfully','127.0.0.1','2026-02-08 05:16:27'),(697,'admin','Logout','User logged out from admin session','127.0.0.1','2026-02-08 05:37:30'),(698,'5436757658200002','Login','Teacher logged in successfully using NUPTK','127.0.0.1','2026-02-08 05:37:33'),(699,'Nur Huda, S.Pd.I.','Absensi Guru','Nur Huda, S.Pd.I. (Wali) memperbarui kehadiran: hadir','127.0.0.1','2026-02-08 05:37:40'),(700,'5436757658200002','Logout','User logged out from wali session','127.0.0.1','2026-02-08 05:40:09'),(701,'admin','Login','User logged in successfully','127.0.0.1','2026-02-08 05:40:12');
...
INSERT INTO `tb_backup_restore` VALUES (11,'backup_2026-02-01_11-29-53.sql','2026-02-01 11:29:54','110.04 KB','Backup manual'),(12,'backup_2026-02-06_15-09-13.sql','2026-02-06 15:09:14','108.32 KB','Backup manual');
...
--
-- Table structure for table `tb_jadwal_imam`
--

DROP TABLE IF EXISTS `tb_jadwal_imam`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tb_jadwal_imam` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `id_guru` (`id_guru`),
  CONSTRAINT `tb_jadwal_imam_ibfk_1` FOREIGN KEY (`id_guru`) REFERENCES `tb_guru` (`id_guru`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tb_jadwal_imam`
--

LOCK TABLES `tb_jadwal_imam` WRITE;
/*!40000 ALTER TABLE `tb_jadwal_imam` DISABLE KEYS */;
INSERT INTO `tb_jadwal_imam` VALUES (1,'Sabtu',30,'2026-02-03 03:54:10','2026-02-03 03:54:10'),(3,'Ahad',22,'2026-02-03 04:14:38','2026-02-03 04:14:38'),(4,'Senin',25,'2026-02-03 04:14:57','2026-02-03 04:14:57'),(5,'Selasa',19,'2026-02-03 04:15:06','2026-02-03 04:15:06'),(6,'Rabu',20,'2026-02-03 04:15:21','2026-02-03 04:15:21'),(7,'Kamis',18,'2026-02-03 04:15:29','2026-02-03 04:15:29');
/*!40000 ALTER TABLE `tb_jadwal_imam` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tb_notifikasi` VALUES (26,'Nur Huda, S.Pd.I. (Wali) telah mengirim kehadiran pada pukul 12:37 tanggal 08-02-2026','absensi_guru.php',1,'2026-02-08 05:37:40');
...
INSERT INTO `tb_pengguna` VALUES (1,'admin','','Admin','$2y$10$9UwGBacp9aQACSPTMXhhJ.lS6kOMAT2MqTWcgP1iyP1CGaSnjHLJ2','admin',NULL,'user_1769126130_LOGO.png'),(2,'kepala',NULL,'Musriah, S.Pd.I.','$2y$10$wKqi4ukTK96K3pUDi5/tq..vwpSS6JsLXOOD28zYfbY3Ceginvd.e','kepala_madrasah',NULL,NULL),(3,'tu',NULL,'Khoiruddin, S.Pd.','$2y$10$wHZGfb.iEFeJzSQ3EAZYYOGbVXVKheuH4.ihYVIg2Du7m20m5uP/W','tata_usaha',NULL,NULL);
...
-- Dump completed on 2026-02-08 12:54:18
