...
// Check if user is logged in and has admin, kepala_madrasah, tata_usaha, guru, wali, or siswa level
if (!isAuthorized(['admin', 'kepala_madrasah', 'tata_usaha', 'guru', 'wali', 'siswa'])) {
    redirect('../login.php');
}

// Ensure table exists
try {
    $pdo->exec("CREATE TABLE IF NOT EXISTS tb_jadwal_seragam_siswa (
...
if (isset($_GET['print'])) {
    ...
    <head>
        <meta charset="UTF-8">
        <title>Jadwal Seragam Siswa_<?php echo str_replace('/', '-', $tahun_ajaran); ?></title>
        <style>
    ...
    <body onload="window.print()">
        ...
        <div class="signature-area">
            ...
            $qr_content = "Validasi Jadwal Seragam Siswa: " . $kepala . " - " . ($school_profile['nama_madrasah'] ?? 'MI Sultan Fattah');
...
// Set page title
$page_title = 'Jadwal Seragam Siswa';
...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Jadwal Seragam Siswa <?php echo $school_profile['tahun_ajaran'] ?? ''; ?></h1>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                ...
                                <?php endif; ?>
                                <a href="jadwal_seragam_siswa.php?print=1" target="_blank" class="btn btn-info">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="" method="POST">
                <div class="modal-header"><h5 class="modal-title">Tambah Jadwal Seragam Siswa</h5></div>
...
<div class="modal fade" id="modalEdit<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="" method="POST">
                <div class="modal-header"><h5 class="modal-title">Edit Jadwal Seragam Siswa</h5></div>
                <div class="modal-body">
        ...
        <div class="modal-content">
            <form action="" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                    <p>Hapus jadwal seragam siswa hari <?php echo $row['hari']; ?>?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
