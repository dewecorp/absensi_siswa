                    ...
                    <?php if ($selected_class && $selected_jenis): ?>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 text-right">
                                <div class="btn-group">
                                    <a href="../guru/export_rekap_nilai_excel?session_type=admin&kelas=<?= $selected_class_id ?>&jenis=<?= urlencode($selected_jenis) ?>&tipe=<?= $selected_tipe ?>" target="_blank" class="btn btn-success">
                                        <i class="fas fa-file-excel"></i> Export Excel
                                    </a>
                                    <a href="../guru/export_rekap_nilai_pdf?session_type=admin&kelas=<?= $selected_class_id ?>&jenis=<?= urlencode($selected_jenis) ?>&tipe=<?= $selected_tipe ?>" target="_blank" class="btn btn-danger">
