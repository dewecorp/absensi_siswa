    ...
    elseif (isset($_POST['add_pengeluaran'])) {
        ...
        if ($stmt->execute([$status, $id])) {
            ...
            if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest') {
                ...
                $rencana_pengeluaran = $pdo->query("SELECT total, status_terlaksana FROM tb_rencana_pengeluaran")->fetchAll(PDO::FETCH_ASSOC);
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                ...
                                <a href="export_excel_rab_madrasah?session_type=<?= $_SESSION['level'] ?>" target="_blank" class="btn btn-success mr-2">
                                    <i class="fas fa-file-excel"></i> Export Excel
                                </a>
                                <a href="cetak_rab_madrasah?session_type=<?= $_SESSION['level'] ?>" target="_blank" class="btn btn-warning mr-2">
