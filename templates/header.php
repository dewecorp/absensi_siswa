...
<head>
    ...
    <!-- Template CSS -->
    <?php
    $_supervisi_path = __DIR__ . '/../assets/css/supervisi.css';
    $_supervisi_v = is_readable($_supervisi_path) ? (string) filemtime($_supervisi_path) : '1';
    ...
    ?>
    <link rel="stylesheet" href="../assets/css/supervisi.css?v=<?php echo htmlspecialchars($_supervisi_v, ENT_QUOTES, 'UTF-8'); ?>">
