...
try {
    switch ($jenis) {
        ...
        case 'arsip':
            ...
            $headers = ['ID Supervisi', 'Jenis Dokumen', 'Nama Dokumen', 'File', 'Tautan Dokumen', 'Tanggal Upload', 'Pengunggah', 'Keterangan'];
            ...
            foreach ($rows as $r) {
                $body[] = [
                    '#' . (int)$r['id_pelaksanaan'], h($r['jenis_dokumen']), h($r['nama_dokumen']),
