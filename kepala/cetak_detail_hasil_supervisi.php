...
$rawTanggalCetak = sv_tanggal_cetak($pdo, 'detail');
...
.ttd{margin-top:6px;width:100%}
.ttd td{border:none;text-align:center;vertical-align:top}
.ttd-wrap{page-break-inside:avoid;break-inside:avoid;margin-top:18px}
...
<div class="ttd-wrap">
<p style="text-align:right;margin:0 0 10px"><?= h($tanggal) ?></p>
<table class="ttd"><tr>
