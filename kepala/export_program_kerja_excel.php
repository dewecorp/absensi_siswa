...
<table>
<tr><td colspan="16" class="header-title"><?=$foundation_name?></td></tr>
<tr><td colspan="16" class="header-title"><?=$school_name?></td></tr>
<tr><td colspan="16" class="header-text"><?=$school_address?></td></tr>
...
<td class="text-center"><?=!empty($r['bukti'])?htmlspecialchars($r['bukti']):'-'?></td>
<td><?=htmlspecialchars($r['evaluasi']??'-')?></td>
<td><?=htmlspecialchars($r['tindak_lanjut']??'-')?></td>
<td class="text-center"><?=htmlspecialchars($status_opts[$r['status']]??'-')?></td>
</tr>
<?php endforeach;?>
</table>
</body></html>
