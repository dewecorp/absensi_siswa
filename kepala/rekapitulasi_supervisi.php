...
$(document).ready(function () {
    ...
    SV.initDataTable('#table-rekap');
    $('#btn-excel').on('click', function () { SV.exportExcel('table-rekap', 'Rekapitulasi Supervisi', 'rekapitulasi_supervisi', true); });
    $('#btn-pdf').on('click', function () { SV.printPdf('table-rekap', 'Rekapitulasi Supervisi', true); });
});
JS;
