...
$page_title = 'Data Program Supervisi';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $can_manage) {
    ...
    redirect('data_program_supervisi.php');
}
...
$(document).ready(function () {
    ...
    $('#sv-filter-ta').on('change', function () { var v = $(this).val(); if (v) window.location.href = 'data_program_supervisi.php?tahun_ajaran=' + encodeURIComponent(v); });
    SV.autoGrowTextareas();
    ...
    $(document).on('click', '.btn-hapus', function () {
        var id = $(this).data('id');
        SV.confirmDelete({ text: 'Program supervisi akan dihapus.', onConfirm: function () { SV.submitPost('data_program_supervisi.php', { aksi: 'hapus', id_program: id }); } });
    });
    $('#btn-seed').on('click', function () {
        SV.confirmDelete({ title: 'Muat Template Program', text: 'Lengkapi data program yang kosong dari template? Data yang sudah benar tidak akan ditimpa.', onConfirm: function () { SV.submitPost('data_program_supervisi.php', { aksi: 'seed' }); } });
    });
...
<div class="modal fade" id="modal-program" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <form method="POST" action="data_program_supervisi.php" id="form-program">
