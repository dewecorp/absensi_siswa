...
<head>
    <meta charset="UTF-8">
    <title>Cetak Daftar Agenda Rapat</title>
    <style>
        * {
...
<div class="title">DAFTAR AGENDA RAPAT</div>
<?php if ($ta !== '' || $sem !== ''): ?>
    <div class="subtitle">Tahun Ajaran <?= h($ta) ?><?= ($ta !== '' && $sem !== '') ? ' - ' : '' ?><?= h($sem) ?></div>
<?php endif; ?>
...
<table class="data-table">
    <thead>
        <tr>
            ...
            <th style="width: 12%;">Pemimpin Rapat</th>
            <th style="width: 10%;">Tempat</th>
            <th style="width: 21%;">Agenda Rapat</th>
            <th style="width: 21%;">Notulensi</th>
        </tr>
    </thead>
    <tbody>
        <?php if (!empty($rows)): ?>
        ...
        <?php else: ?>
            <tr>
                <td colspan="8" style="text-align: center; color: #777;">Tidak ada data agenda rapat.</td>
            </tr>
        <?php endif; ?>
    </tbody>
</table>
