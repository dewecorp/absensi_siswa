                    ...
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <div class="btn-group mr-2">
                                <a href="../config/export_jurnal_pdf?session_type=guru&kelas=<?php echo $_GET['kelas'] ?? ''; ?>&jenis=<?php echo $_GET['jenis'] ?? ''; ?>" target="_blank" class="btn btn-danger">
                                    <i class="fas fa-file-pdf"></i> Export PDF
                                </a>
                                <a href="../config/export_jurnal_excel?session_type=guru&kelas=<?php echo $_GET['kelas'] ?? ''; ?>&jenis=<?php echo $_GET['jenis'] ?? ''; ?>" target="_blank" class="btn btn-success">
