...
<html>
<head>
    <title>Nilai Kokurikuler - <?= htmlspecialchars($class_info['nama_kelas']) ?> - <?= htmlspecialchars($mapel_info['nama_mapel']) ?></title>
    <style>
...
<body>
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <h3 style="margin: 0; margin-bottom: 15px; text-decoration: underline;">DAFTAR NILAI KOKURIKULER</h3>
        <table style="width: 100%; border: none; font-size: 12px; margin-top: 10px;">
            ...
            <tr style="border: none;">
                ...
                <td style="border: none; text-align: left; width: 25%; padding: 2px;">: <?= htmlspecialchars($class_info['wali_kelas'] ?? '-') ?></td>
            </tr>
        </table>
    </div>
            ...
            <tr>
                <?php foreach ($grade_headers as $header): ?>
                    <th colspan="2" style="font-weight: normal; font-style: italic; background-color: #fff;">
                        <?= htmlspecialchars($header['jenis_kegiatan'] ?? '-') ?> <br>
                        (<?= htmlspecialchars($header['tgl_kegiatan'] ?? '-') ?>)
                    </th>
                <?php endforeach; ?>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                foreach ($grade_headers as $header) {
                    ...
                    if ($valForAvg !== '' && $valForAvg !== null && $valForAvg > 0) {
