...
<body>
    ...
    <div class="header" style="border-bottom: 3px solid #000; padding-bottom: 10px; margin-bottom: 20px;">
        <table style="width: 100%; border: none; margin: 0;">
            <tr style="border: none;">
                ...
                <!-- Empty cell to balance the logo if needed, or just let the center take remaining space. 
                     But usually 2 cells (Logo + Text) is standard. 
                     To center the text perfectly relative to page, we might need a third cell or colspan. 
                     Let's stick to 2 cells, but give logo fixed width. -->
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <h3 style="margin: 0; margin-bottom: 15px; text-decoration: underline;">DAFTAR NILAI HARIAN</h3>
